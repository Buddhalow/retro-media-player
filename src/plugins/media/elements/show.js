...
import { loadTemplate } from '@/util/template.js'
...
export default class SPShowElement extends SPResourceElement {
    ...
    async render() {
        ...
        this.object = obj;
        let template = await loadTemplate('@/plugins/media/templates/show.ejs')
        let html = template({
        ...
        this.innerHTML = html
        console.log(html)
     /*   this.trackcontext = this.querySelector('sp-episodecontext')
