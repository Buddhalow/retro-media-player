import { getPageIdentity } from "@/util.js";
  ...
  connectedCallback() {
    ...
    this.form.addEventListener("submit", (event) => {
      ...
      if (query.indexOf(":") == -1) {
        ...
        query = `bungalow:@${identity.user}@${identity.hostname}:search:${encodeURIComponent(query)}`;
      }
    ...
    this.form.searchDiv.innerHTML =
      '<i style="opacity: 0.5; color: black; text-shadow: none; margin-right: 5pt; margin-left: 5pt" class="fa fa-search"></i>';
