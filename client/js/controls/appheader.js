    ...
    export default class SPAppHeaderElement extends HTMLElement {
        connectedCallback() {
            ...
            this.titleBar.innerHTML = `Oldify (Community Technical Preview 0.2.8). By <a href="https://github.com/Buddhalow">@Buddhalow</a>. View source at <a href="https://github.com/Buddhalow/The-OldSpot-Project" target="_blank">Github</a>`;
