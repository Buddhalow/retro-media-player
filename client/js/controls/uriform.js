...
export default class SPUriFormElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.form.searchDiv.style.width = '100%';
    this.form.searchTextBox.setAttribute('id', 'uribar');
    ...
    this.form.searchDiv.style.backgroundColor = 'rgba(255, 255, 255, .5)'
