...
import musicService from '/js/concepts/music/service.js';
...
class PlayerStore extends EventEmitter {
    ...
    getDevices() {
        return new Promise((resolve, fail) => {
            fetch(`https://api.music.com/v1/me/player/devices`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${window.musicToken}`
                },
    ...
    async setActiveDevice(device_id) {
        return new Promise((resolve, fail) => {
            fetch(`https://api.music.com/v1/me/player`, {
                method: 'PUT',
    ...
    play(context) {
        return new Promise((resolve, fail) => {
            this.player._options.getOAuthToken(access_token => {
                fetch(`https://api.music.com/v1/me/player/play?device_id=${this.state.device_id}`, {
                    method: 'PUT',
