import SPResourceElement from '/js/plugins/spotify/elements/resource.js';
import store from '/js/plugins/spotify/store.js';
export default class SPShowContextElement extends SPResourceElement {
    ...
    createPlaylist (playlist) {
        let elm = document.createElement('sp-show');
